  ...
  return (
    <form onSubmit={submit} className="space-y-5 rounded-3xl bg-white p-5 ring-1 ring-emerald-100 md:p-8">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <label className="font-bold">開始時刻<select className={inputClass} name="startHour" defaultValue="18">{Array.from({ length: 24 }, (_, hour) => <option key={hour} value={hour}>{hour}:00</option>)}</select></label>
      ...
      <p className="-mt-2 text-sm text-slate-500">スマホで塗りやすいよう、候補日は7日以内・1日の時間帯は8時間以内にしてください。</p>
